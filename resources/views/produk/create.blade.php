                                ...
                                <div class="row gy-4">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="kd_produk" class="form-control" required placeholder="Input Kode Produk">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="nama_produk" class="form-control" required placeholder="Input Nama Produk">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label" for="default-03">Harga</label>
                                            <div class="form-control-wrap">
                                                <input type="number" name="harga" class="form-control" required placeholder="Input Harga">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
